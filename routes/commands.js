...
router.post('/', auth, commandController.sendCommand);
router.get('/history', auth, commandController.getCommandHistory);


// Device-side
router.post('/:deviceId/ack', commandController.acknowledgeCommand);
