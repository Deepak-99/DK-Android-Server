...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    ...
    try {
      ...
      // Check if tables already exist (case-insensitive check)
      ...
      if (!tableNames.includes('devices')) {
        ...
        await queryInterface.createTable('devices', {
          ...
          deviceId: {
            ...
            allowNull: false,
            unique: true,
            field: 'device_id' // Explicitly set the column name to match the foreign key
          },
          name: {
            type: Sequelize.STRING,
            allowNull: true
        ...
        console.log('Devices table already exists, skipping creation');
      }
  ...
  down: async (queryInterface, Sequelize) => {
    ...
    try {
      ...
      await transaction.commit();
      console.log('Successfully rolled back initial schema');
    } catch (error) {
      await transaction.rollback();
      console.error('Error rolling back initial schema:', error);
      throw error;
    }
  }
};
